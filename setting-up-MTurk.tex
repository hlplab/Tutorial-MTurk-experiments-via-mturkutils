...
On Windows, directly set all three variables by editing your system environment variables. On Mac or Linux machines, create a credentials file in \~/.aws (i.e. \~/.aws/credentials) and edit it to contain the following lines (case matters!):
...
Next, create and edit the config file in \~/.aws (i.e. \~/.aws/config):
...
\textbf{Be sure to get this working before continuing!}
