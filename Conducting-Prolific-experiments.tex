...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/vis_infoflow_prolific}
...
Before doing further, one should create a free account (or secure access to lab accounts) for both Prolfic and Proliferate.
