...
Follow the steps described in Section \ref{sec:obtain-sandbox-results} for getting results from the sandbox {\bf except without the \texttt{-s} flag} (since you're now getting results from Mechanical Turk, rather than Mechanical Turk's sandbox).
