...
//        $(this.auds).bind('ended.' + this.namespace, function() {_self.waitForResp();});
                    ...
                    $("#testInstructions").show().addClass("dimmed");        
                     if (_self.mediaType == 'audio') 
                     {
                         ...
                         $originalAudio.on('ended', function() 
                         {
                            ...
                            $("#subtitle1").show().text(_self.stimuliObj.probes1[_self.stims[_self.n]]);
                            $("#subtitle2").show().text(_self.stimuliObj.probes2[_self.stims[_self.n]]);
    ...
    info: function() {
        ...
        //} else {
        //return [this.namespace, this.n, this.stims[this.n], _self.stimuliObj.filenames[_self.stims[_self.n]], _self.stimuliObj.probes1[_self.stims[_self.n]],_self.stimuliObj.probes2[_self.stims[_self.n]],_self.stimuliObj.targets[_self.stims[_self.n]],_self.stimuliObj.correctKeys[_self.stims[_self.n]],].join(); 
       // }
