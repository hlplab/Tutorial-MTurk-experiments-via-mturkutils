...
//        $(this.auds).bind('ended.' + this.namespace, function() {_self.waitForResp();});
    ...
    fb: function(e) {
                ...
                console.log('Timeout,showing feedback!');
                } 
    ...
    // handle end of trial (called by key press handler)
        ...
        console.log('AudioLength is '+ (this.tAudioOff-this.tAudioOn));
    ...
    info: function() {
        ...
        return [this.namespace, this.n, this.stims[this.n], _self.stimuliObj.trialtypes[_self.stims[_self.n]],_self.stimuliObj.wordtypes[_self.stims[_self.n]],_self.stimuliObj.filenames[_self.stims[_self.n]], _self.stimuliObj.primes[_self.stims[_self.n]], _self.stimuliObj.probes[_self.stims[_self.n]],_self.stimuliObj.correctKeys[_self.stims[_self.n]],].join(); 
        } else {
