   ...
   // var TrL = e.urlparams['TrL'];    //which training list A or B
        ...
        var instructions = new InstructionsSubsectionsBlock(
            {
                ...
                title: 'Laurel or Yanny: What do you hear?',
    ...
    /*Rest of the experiment here*/
        ...
        var instructions_1 = new InstructionsSubsectionsBlock(
            {
                instrImg: 'img/practice_diagram_fb.png',
                instrStyle: 'logo2',
                ...
                mainInstructions: ['READ THE FOLLOWING INSTRUCTIONS CAREFULLY', 
                                   ...
                                   "Let's start with some practice to familiarize you with the task. In this practice, you will hear a series of words. After each word, two printed words will appear on the screen. Your job is to identify the word on the screen that matches the word you hear. <span style='font-weight:bold;'>Press Q if you hear the word on the left, press P if you hear the word on the right</span>. The image below presents a schematic diagram of the procedure. <br>",
      ...
      var sampleStim = new ExtendedStimuliFileList(
            {
                ...
                mediaType: 'audio',
                trialtypes: ['sample','sample','sample','sample','sample','sample','sample','sample','sample','sample','sample'], //sentence is not in usable stimulus list; speaker is not either
                ...
                targets: ['chip','grill','bark','beans','wax','dart','lamp','rent','pole','jail','lid'],
                correctKeys: ['right','left','left','right','left','right','right','right','left','left','right']
            }
        );
        var sampleBlock = new AFCBlock_replay({stimuli: sampleStim,
...
///TRAINING BLOCK
        Papa.parse(trainingList, {
            ...
            complete: function(results) {
             ...
             var trainingBlock = new AFCBlock_replay({stimuli: trainingStim,
                             blockRandomizationMethod: "dont_randomize",
                             trialInstructions: "Which word do you hear?",
                             reps: 1,
    ...
    var instructions_2 = new InstructionsSubsectionsBlock(
        ...
        Papa.parse(test1List, {
            ...
            complete: function(results) {
             ...
             var test1Block = new AFCBlock({stimuli: test1Stim,
                             ...
                             feedback: false,
                             fixationTime: 750,
                             ITI:500, // this interval is used to present feedback if any
                             mediaType: 'audio',
                             namespace: 'test1'});                                
            e.addBlock(
                  {
                  ...
                  ///TEST BLOCK 2
                    ...
                    Papa.parse(test2List, {
                        ...
                        complete: function(results) {
                         ...
                         var test2Block = new AFCBlock({stimuli: test2Stim,
                             blockRandomizationMethod: "shuffle",
                             trialInstructions: "Which word do you hear?",
                             reps: 1,
                             respKeys: {'Q': 'left', 'P': 'right'}, 
